...
contract StorageHelper_Test is Test, StorageHelper {
    ...
    function test4_getLastReadSlots() public {
        ...
        bytes32[] memory lastReadSlots = _getLastReadSlots(address(example));
        ...
        lastReadSlots = _getLastReadSlots(address(example));
    ...
    function test4_getLastWrittenSlots() public {
        ...
        bytes32[] memory lastWrittenSlots = _getLastWrittenSlots(address(example));
        ...
        lastWrittenSlots = _getLastWrittenSlots(address(example));
